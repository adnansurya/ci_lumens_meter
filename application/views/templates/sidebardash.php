...
<nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="<?= base_url('admin/grapik1'); ?>"><img src="<?= base_url('Logo/graph.png'); ?>" alt="img" style="max-width: 20px; max-height: 20px"> Grafik Lux</a>
            </li>
            <li>
                <a href="<?= base_url('admin/grapik2'); ?>"><img src="<?= base_url('Logo/graph.png'); ?>" alt="img" style="max-width: 20px; max-height: 20px"> Grafik Daya</a>
            </li>
            <li>
                <a href="<?= base_url('admin/persentase'); ?>"><img src="<?= base_url('Logo/graph.png'); ?>" alt="img" style="max-width: 20px; max-height: 20px"> Grafik Persentase</a>
            </li>
            <li>
